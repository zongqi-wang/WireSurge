...
| [0002 Numeric domains and scheduling semantics](0002-numeric-domains-and-scheduling.md) | Conservative closed numeric domains; deadline checked after rate admission | Proposed |
